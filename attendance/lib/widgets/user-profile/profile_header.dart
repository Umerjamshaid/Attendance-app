    ...
    return Container(
      ...
      child: Stack(
        children: [
          ...
          Positioned(top: -40, right: -40, child: _glowCircle(160, 0.06)),
          Positioned(bottom: -20, right: 80, child: _glowCircle(90, 0.04)),
          Positioned(top: 20, right: 120, child: _glowCircle(50, 0.03)),
        ],
      ),
    );
  }
